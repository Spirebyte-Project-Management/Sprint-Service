...
public class Sprint
{
    public Sprint(string id, string title, string description, string projectId, string[] issueIds, DateTime createdAt,
        DateTime startedAt, DateTime startDate, DateTime endDate, DateTime endedAt)
    {
